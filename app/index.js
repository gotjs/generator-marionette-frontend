...
MarionetteFrontendGenerator.prototype.vendors = function plugins() {

    var cb = this.async();
    this.invoke('marionette-frontend:vendor', { options: { vendor : 'handlebars', predefined : true, autoload : true }}, cb);
